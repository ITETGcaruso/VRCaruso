...
public class OVRInspector : MonoBehaviour
{
    ...
    static public OVRCameraRig cameraRig 
    {
        get
        {
            return GameObject.FindGameObjectWithTag("ovrCameraRig").GetComponent<OVRCameraRig>();
            return GameObject.Find("OVRCameraRig").GetComponent<OVRCameraRig>();//this shit is abominable
        }
    }
